...
const RULES = [
  // Investment first — a payment to a broker/fund is "good" money behaviour and
  // should win over a generic Transfer/Raast keyword match.
  {
    category: "Investment",
    keywords: [
      "akd", "securities", "brokerage", "broker", "psx", "stock exchange",
      "stocks", "shares", "equity", "mutual fund", "mutual", "investment",
      "invest", "al meezan", "meezan investment", "ubl fund", "nbp fund",
      "mcb arif habib", "alfalah ghp", "roshan digital", "sarmaya", "mahaana",
      "sukuk", "bonds", "etf", "trading account", "zari services",
    ],
  },
  {
