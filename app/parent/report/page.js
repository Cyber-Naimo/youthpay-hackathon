              ...
              {stats.breakdown.map((b) => {
                ...
                return (
                  <tr key={b.category} className="border-b border-slate-100">
                    ...
                    <td className="tnum py-2 text-right font-semibold text-slate-900">{formatPKR(b.amount)}</td>
            ...
            <tbody>
              {recent.map((t) => (
                <tr key={t.id} className="border-b border-slate-100">
                  <td className="py-1.5 whitespace-nowrap text-slate-500">{format(new Date(t.date), "d MMM")}</td>
                  <td className="py-1.5 text-slate-700">{t.merchant_name}</td>
                  <td className="py-1.5 text-slate-400">{t.category}</td>
                  <td className={`tnum py-1.5 text-right font-semibold ${t.type === "credit" ? "text-green-600" : "text-slate-900"}`}>
